...
export const Layout = (props: LayoutProps) => {
    ...
    <head>
      ...
      <style>
        ...
        /* Override PicoCSS default margins causing layout issues */
        ...
        button.contrast, button.secondary, button.outline {
            background: transparent !important;
            border: 1px solid #cbd5e1;
            color: var(--text-sub);
            box-shadow: none;
        }
        button.contrast:hover, button.secondary:hover, button.outline:hover {
        ...
        h2, h3, h4 { color: var(--text-main); font-weight: 700; letter-spacing: -0.02em; }
        ...
        dialog > article > header > .modal-title {
            font-size: 1.2rem;
            font-weight: normal;
            color: var(--text-main);
        }
        ...
        dialog .close svg { pointer-events: none; width: 24px; height: 24px; }
        dialog .close::before, dialog .close::after { display: none !important; }
        ...
        dialog button.outline, dialog button.secondary {
            background: transparent !important;
            border: 1px solid #cbd5e1;
            color: var(--text-sub) !important;
            box-shadow: none !important;
        }
        dialog button.outline:hover, dialog button.secondary:hover {
