...
interface LayoutProps {
  title: string
  lang?: string // Default 'ja' or handled by caller
  width?: number | string // custom max-width, e.g. 800 or '100%'. Default 400px
  children: any // Hono html literal or string
}
  ...
  return html`
    ...
    <head>
      ...
      <style>
        :root {
            --primary: #4f46e5;
            /* ... (omitted same vars for brevity if desired, but here I keep them same) */
